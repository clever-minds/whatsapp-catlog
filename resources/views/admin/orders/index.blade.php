...
<!-- Tailwind Safelist for dynamic DataTable row classes -->
<div class="hidden !bg-green-100 hover:!bg-green-200 transition-colors"></div>

<div class="bg-white shadow rounded-lg overflow-x-auto overflow-y-hidden p-6">
    <table id="orders-table" class="min-w-full leading-normal w-full stripe hover">
        <thead>
            <tr>
...
<script>
    $(document).ready(function() {
        $('#orders-table').DataTable({
            ...
            columns: [
                { data: 'id', name: 'id', render: function(data) { return '#' + String(data).padStart(5, '0'); } },
